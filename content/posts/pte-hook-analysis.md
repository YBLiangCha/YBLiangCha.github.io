...
PTE Hook其实已经是一种比较古老的方法了，不过研究完之后，我觉得对于x64架构的认识以及Windows内核的入门还挺有帮助的。
